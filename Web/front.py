...
from Controllers import parityCheckWeb, hadamard, hammingcode
import flask
...
@application.route('/')
def serve():
    return flask.render_template("index.html", result="", noisy=noise, a="", b="", c="")
...
if __name__ == '__main__':
    import os
    port = int(os.environ.get('PORT', 33599))
